...
WebUI.click(findTestObject('Site_Navigation/Page_Homepage/button_StudentEducators'))
...
WebUI.mouseOver(findTestObject('Object Repository/Site_Navigation/Page_Homepage/button_StudentEducators'))

WebUI.waitForElementPresent(findTestObject('Site_Navigation/Page_XYZ Homepage - Contact/a_ed2go'), 10)

//WebUI.switchToWindowIndex(0)
WebUI.click(findTestObject('Site_Navigation/Page_XYZ Homepage - Contact/a_ed2go'))
...
WebUI.mouseOver(findTestObject('Object Repository/Site_Navigation/Page_Homepage/button_Contact Us'))
