...
WebUI.verifyElementText(findTestObject('Footer/Page_About Cengage/h3_About Us'), 'About Cengage')

WebUI.click(findTestObject('Footer/Page_Homepage/a_Our Brands'))

WebUI.verifyElementText(findTestObject('Footer/Page_Our Brands/h2_Our Brands'), 'Our Brands')

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Footer/Page_Leadership/a_Home'))

WebUI.click(findTestObject('Footer/Page_Homepage/a_Leadership'))

WebUI.verifyElementText(findTestObject('Footer/Page_Leadership/h2_Leadership'), 'Leadership')
...
WebUI.click(findTestObject('Footer/Page_Homepage/a_Employee Experience'))

WebUI.verifyElementText(findTestObject('Footer/Page_Employee Experience/h2_Employee Experience'), 'Employee Experience')

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Footer/Page_Inclusion  Diversity/a_Home'))

WebUI.click(findTestObject('Footer/Page_Homepage/a_Inclusion  Diversity'))

WebUI.verifyElementText(findTestObject('Footer/Page_Inclusion  Diversity/h2_Our Commitment'), 'Our Commitment to Inclusion & Diversity')

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Object Repository/Footer/Page_Our Brands/a_Home'))

WebUI.click(findTestObject('Footer/Page_Cengage Corporate/a_Media Resources'))

WebUI.verifyElementText(findTestObject('Footer/Page_Media Resources/h2_Media Resources'), 'Media Resources')

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Footer/Page_Media Resources/a_Home'))
...
WebUI.verifyElementText(findTestObject('Footer/Page_/h2_Press Releases'), 'Press Releases')

WebUI.takeFullPageScreenshot()

WebUI.click(findTestObject('Footer/Page_Press Releases/a_Home'))

WebUI.click(findTestObject('Object Repository/Footer/Page_Homepage/a_In the News'))

WebUI.verifyElementText(findTestObject('Footer/New/Page_/h2_In The News'), 'In The News')
...
WebUI.verifyElementText(findTestObject('Footer/New/Page_/h2_Awards'), 'Awards')
...
WebUI.verifyElementText(findTestObject('Footer/New/Page_/h2_Perspectives'), 'Perspectives')
...
WebUI.verifyElementText(findTestObject('Footer/New/Page_Investors/h2_Investors'), 'Investors')
...
WebUI.verifyElementText(findTestObject('Footer/SocialMedia/Page_Webcasts  Presentations/Page_Presentations - Cengage Corporate/Page_Presentations - Cengage Corporate/h1_Presentations'), 
    'Presentations')
...
WebUI.verifyElementText(findTestObject('Footer/Page_Careers/h2_Careers'), 'Careers')
...
WebUI.verifyElementText(findTestObject('Object Repository/Footer/Page_Contact/h2_Contact'), 'Contact Us')
