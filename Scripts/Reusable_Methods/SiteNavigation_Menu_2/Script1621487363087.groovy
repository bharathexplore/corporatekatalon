...
WebUI.verifyElementText(findTestObject('Site_Navigation/Page_/h3_Press Releases'), 'Press Releases')
...
WebUI.verifyElementText(findTestObject('Site_Navigation/Page_/h3_In The News'), 'In The News')
...
WebUI.verifyElementText(findTestObject('Site_Navigation/Page_/h3_Perspectives'), 'Perspectives')
...
WebUI.verifyElementText(findTestObject('Site_Navigation/Page_/h3_Awards'), 'Awards')
