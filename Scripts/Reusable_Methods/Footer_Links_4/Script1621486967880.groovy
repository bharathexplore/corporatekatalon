...
WebUI.verifyElementText(findTestObject('Object Repository/Footer/Page_Homepage/a_Annual Reports'), 'Annual Reports')
...
WebUI.verifyElementText(findTestObject('Object Repository/Footer/Page_Homepage/a_FAQs'), 'FAQ\'s')
...
WebUI.verifyElementText(findTestObject('Object Repository/Footer/Page_Homepage/a_Permissions'), 'Permissions')
