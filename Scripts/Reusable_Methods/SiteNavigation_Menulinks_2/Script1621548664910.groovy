...
WebUI.verifyElementText(findTestObject('Site_Navigation/Page_Current Reports/a_Annual Reports'), 'Annual Reports')
...
WebUI.verifyElementText(findTestObject('Site_Navigation/Page_Careers/a_Careers FAQ'), 'Careers FAQ')
